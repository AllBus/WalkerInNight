...
/*
     ...
     * @param viewHeight
     */
    public void beginDrawing(float viewWidth, float viewHeight) {
      ...
      /*  GLES20.glColor4x(0x10000, 0x10000, 0x10000, 0x10000);
        ...
        GLES20.glOrthof(0.0f, viewWidth, 0.0f, viewHeight, 0.0f, 1.0f);
        GLES20.glMatrixMode(GLES20.GL_MODELVIEW);
        GLES20.glPushMatrix();
        GLES20.glLoadIdentity();
        // Magic offsets to promote consistent rasterization.
        GLES20.glTranslatef(0.375f, 0.375f, 0.0f);*/
    }
    ...
    public void draw( float x, float y, int labelID) {
     ...
     /*   checkState(STATE_DRAWING, STATE_DRAWING);
        ...
        ((GL11)gl).glTexParameteriv(GLES20.GL_TEXTURE_2D,
    ...
    public void selectTexture(Shader shader)
    {
    	shader.linkTexture(mTextureID, GLES20.GL_TEXTURE0,"u_Texture");
    }
